...
```
cd existing_repo
git remote add origin https://gitlab.com/kamaslau/trial-prometheus.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kamaslau/trial-prometheus/-/settings/integrations)
